...
# Girls U10 HAYSA Bulldogs team ID
HOLBROOK_ID = "2640"
...
TEAM_PAGE_URL = "https://apps.daysmartrecreation.com/dash/x/#/online/unionpointsports/teams/2640"
...
def build_team_map(included):
    ...
    # Override friendly name for our team
    teams[HOLBROOK_ID] = teams.get(HOLBROOK_ID, "(U10G) HAYSA Bulldogs")
    return teams
...
def write_ics(events, teams, scores_by_event, filename="U10G_schedule.ics"):
...
def main():
    ...
    print(f"Found {len(holbrook_games)} HAYSA Bulldogs games")
    ...
    print("✅ HAYSA Bulldogs-only ICS generated: U10G_schedule.ics")
